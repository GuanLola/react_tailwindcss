...
function Home() {
  ...
  const [angle, setAngle] = useState(-1300)
  ...
  return (
    <div className="bg-white transition duration-500">
      <div className="px-5vw py-9 lg:py-12">
        <nav className="text-primary mx-auto flex max-w-8xl items-center justify-between">
          ...
          <ul className="hidden lg:flex">
            {liItem.map((v) => (
              <li className="px-5 py-2" key={v}>
                <a
                  className="underlined focus:outline-none block whitespace-nowrap text-lg font-medium hover:text-team-current focus:text-team-current text-secondary"
                  href="/"
                >
                  {v}
                </a>
          ...
          <div className="flex items-center justify-center" >
            ...
            <a className="focus:outline-none ml-4 inline-flex h-14 w-14 items-center justify-center rounded-full" href="/">
              <div className="absolute" style={{ transform: `rotate(${angle}deg) translateZ(0px)` }}>
                <svg height="56" width="56" viewBox="0 0 56 56">
                  <path d="M29.465,0.038373A28,28,0,0,1,52.948,40.712L51.166,39.804A26,26,0,0,0,29.361,2.0356Z" className="text-team-yellow" fill="currentColor"></path>
                  <path d="M51.483,43.250A28,28,0,0,1,4.5172,43.250L6.1946,42.161A26,26,0,0,0,49.805,42.161Z" className="text-team-blue" fill="currentColor"></path>
                  <path d="M3.0518,40.712A28,28,0,0,1,26.535,0.038373L26.639,2.0356A26,26,0,0,0,4.8338,39.804Z" className="text-team-red" fill="currentColor"></path>
                </svg>
              </div>
              <img className="inline w-10 select-none rounded-full" src="https://res.cloudinary.com/kentcdodds-com/image/upload/q_auto,f_auto/kentcdodds.com/illustrations/kody_profile_white" alt="Kody Profile in White" />
            </a>
          </div>
        </nav>
      </div>
